...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/avatars',
      name: 'Avatars',
      component: () => import('../views/UiElements/AvatarsView.vue'),
      meta: {
        title: 'Avatars',
      },
    },
    {
      path: '/badge',
      name: 'Badge',
      component: () => import('../views/UiElements/BadgesView.vue'),
      meta: {
        title: 'Badge',
      },
    },
...

    {
      path: '/images',
      name: 'Images',
      component: () => import('../views/UiElements/ImagesView.vue'),
      meta: {
        title: 'Images',
      },
    },
    {
      path: '/videos',
      name: 'Videos',
      component: () => import('../views/UiElements/VideosView.vue'),
      meta: {
        title: 'Videos',
      },
    },
