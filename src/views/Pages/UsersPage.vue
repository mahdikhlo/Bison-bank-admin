<template>
    ...
    <div class="p-6 space-y-6 min-h-screen">
        ...
        <div class="flex justify-between items-center">
            ...
            <button @click="openUserModal()" class="px-4 py-2 bg-brand-500 text-white rounded-lg hover:bg-brand-600">
                Create New User
            </button>
        </div>
                ...
                >
                  {{ user.suspended === false ? 'active' : 'suspended' }}
                    ...
                    <td class="px-4 py-2 text-gray-700 dark:text-gray-300 space-x-2">
                        ...
                        <button @click="toggleSuspend(user)" :class="user.suspended ? 'bg-green-500 hover:bg-green-600' : 'bg-red-500 hover:bg-red-600'" class="px-2 py-1 text-white rounded text-xs">
