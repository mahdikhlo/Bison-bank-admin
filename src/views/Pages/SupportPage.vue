...
const tickets = reactive([
    { id: 1, user: 'John Doe', subject: 'Login Issue', status: 'Open', messages: [{from:'User', text:'Cannot login', date:'2025-09-06'}] },
    { id: 2, user: 'Jane Smith', subject: 'Payment Problem', status: 'Closed', messages: [{from:'User', text:'Payment failed', date:'2025-09-05'}] },
    { id: 3, user: 'Alice', subject: 'Account Update', status: 'Open', messages: [{from:'User', text:'Need to update email', date:'2025-09-04'}] }
])
